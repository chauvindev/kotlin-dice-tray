...
actual class TargetSpecificDieTest {
    actual fun runBlockingTest(block: suspend (scope : CoroutineScope) -> Unit) = kotlinx.coroutines.test.runBlockingTest { block(this) }

    @Test
    actual fun suspendable_roll_function_returns_flow_of_roll_result() = this.runBlockingTest {
        val die = Die(1, 6)
    ...
    @Test
    actual fun suspendable_roll_result_is_sum_of_roll_and_modifiers() = this.runBlockingTest {
